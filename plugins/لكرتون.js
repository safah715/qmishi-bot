...
let handler = async (m, { conn }) => {
  ...
  try {
    ...
    // تحميل الصورة الناتجة كـ Buffer وحفظها مؤقتًا
    ...
    await conn.sendMessage(
      m.chat,
      { image: { url: out }, caption: "━━━╄━✾ 「💠」 ✾━╃━━━\n*✨ ها هي صورتك بعد التحويل إلى أنمي!*\n━━━╄━✾ 「💠」 ✾━╃━━━" },
      { quoted: m }
    )

    setTimeout(() => {
      fs.unlinkSync(out)
    }, 15000) // يحذف الصورة بعد 15 ثانية
  } catch (e) {
    console.error('❌ خطأ:', e)
