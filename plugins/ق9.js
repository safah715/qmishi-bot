...
menuText += `*⌬──══─┈•⤣🌓⤤•┈─══──⌬*\n\n`
menuText += `*⌬──══─┈•⤣🌙⤤•┈─══──⌬*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁🖼️❯ اتش_دي 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁🖼️❯ بينتريست 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁🖼️❯ صوره 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁🖼️❯ خلفيه 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁🖼️❯ خلفيات 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁🖼️❯ ايديت 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁🖼️❯ ايديت_كوره 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁🖼️❯ ايديت_سيارات 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁🖼️❯ ايديت_انمي 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁🖼️❯ كابيلز 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁🖼️❯ تطقيم 』*\n`
menuText += `*⌬──══─┈•⤣🌙⤤•┈─══──⌬*\n\n`

await conn.sendMessage(m.chat, { react: { text: '🖼️', key: m.key } })

    const localImagePath = join(process.cwd(), 'src', 'menu9.jpg')
