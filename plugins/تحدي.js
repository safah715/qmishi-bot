...
var handler = async (m, { conn, usedPrefix }) => {
    ...
    try {
        const media = await prepareWAMessageMedia(
            { image: { url: 'https://telegra.ph/file/1aad4df0913a6e482fa34.jpg' } }, 
        ...
        await conn.reply(m.chat, `⃝🌙 *حـدث خـطأ أثـنـاء تـشـغـيل الـتـحدي*`, m);
    }
};

handler.help = ['تحدي'];
handler.tags = ['games'];
handler.command = ['حديه', 'حدي', 'تحدي'];
