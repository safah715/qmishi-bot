...
menuText += `*║* *『 ⌬╎°⃟𑁁🏅❯ طرد 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁🏅❯ انذار 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁🏅❯ الغاء_انذار 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁🏅❯ انذارات 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁🏅❯ لينك 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁🏅❯ اعفاء 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁🏅❯ ترقيه 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁🏅❯ المتصلين 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁🏅❯ تجديد 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁🏅❯ مخفي 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁🏅❯ حذف 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁🏅❯ كتم 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁🏅❯ فك_الكتم 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁🏅❯ منع_الخليج 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁🏅❯ منع_الروابط 』*\n`
menuText += `*⌬──══─┈•⤣🌙⤤•┈─══──⌬*\n\n`


    await conn.sendMessage(m.chat, { react: { text: '🏅', key: m.key } })

    const localImagePath = join(process.cwd(), 'src', 'menu1.jpg')
