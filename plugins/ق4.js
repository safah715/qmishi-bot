...
let handler = async (m, { conn, usedPrefix: _p }) => {
  try {
    ...
    // نص القائمة الرئيسية - تم تحديث الاسم والزخرفة
let menuText = `*⌬══𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃 𝐌𝐄𝐍𝐔══⌬*\n`
...
menuText += `*║* *『 ⌬╎°⃟𑁁📥❯ تيك 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁📥❯ بينتر 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁📥❯ ميديا_فاير 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁📥❯ شغل 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁📥❯ شغل2 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁📥❯ جيتهاب 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁📥❯ سبوتيفاي 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁📥❯ تيكتوك 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁📥❯ يوتيوب 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁📥❯ فيديو 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁📥❯ صوت 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁📥❯ اغنيه 』*\n`
menuText += `*║* *『 ⌬╎°⃟𑁁📥❯ تيرابوكس 』*\n`
menuText += `*⌬──══─┈•⤣⚡⤤•┈─══──⌬*\n\n`

await conn.sendMessage(m.chat, { react: { text: '🔍', key: m.key } })

    const localImagePath = join(process.cwd(), 'src', 'menu4.jpg')
